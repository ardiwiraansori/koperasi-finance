...
<div class="kpi-grid">
    <div class="kpi-card"><div class="kpi-icon blue">👥</div><div><span>Anggota Aktif</span><strong><?php echo e(number_format($stats['members'])); ?></strong><small class="positive">↑ 4,8% <em>dari bulan lalu</em></small></div></div>
    <div class="kpi-card"><div class="kpi-icon green">◫</div><div><span>Total Simpanan</span><strong>Rp <?php echo e(number_format($stats['savings']/1000000,1,',','.')); ?> Jt</strong><small class="positive">↑ 6,2% <em>dari bulan lalu</em></small></div></div>
    <div class="kpi-card"><div class="kpi-icon purple">↗</div><div><span>Pinjaman Beredar</span><strong>Rp <?php echo e(number_format($stats['loans']/1000000,1,',','.')); ?> Jt</strong><small class="muted">3 pinjaman aktif</small></div></div>
    <div class="kpi-card"><div class="kpi-icon orange">!</div><div><span>Tunggakan</span><strong>Rp <?php echo e(number_format($stats['arrears']/1000000,1,',','.')); ?> Jt</strong><small class="negative">Perlu perhatian</small></div></div>
</div>
...
<div class="dashboard-grid">
    <section class="card chart-card">
        ...
        <div class="chart-stats"><div><span>Kas Masuk September</span><strong>Rp <?php echo e(number_format($stats['income'],0,',','.')); ?></strong></div><div><span>Posisi Kas & Bank</span><strong>Rp <?php echo e(number_format($stats['cash'],0,',','.')); ?></strong></div></div>
    </section>

    <section class="card approval-card">
        <div class="card-head"><div><h2>Perlu Approval</h2><p>Menunggu tindakan Anda</p></div><a href="<?php echo e(route('approval.index')); ?>">Lihat semua</a></div>
        <div class="approval-list">
            <a href="<?php echo e(route('loans.index')); ?>" class="approval-item"><span class="approval-icon blue">↗</span><div><strong>Pengajuan Pinjaman</strong><small>3 pengajuan baru</small></div><b>3</b><i>›</i></a>
...
<div class="dashboard-grid lower">
    <section class="card">
        <div class="card-head"><div><h2>Transaksi Terakhir</h2><p>Aktivitas kasir hari ini</p></div><a href="<?php echo e(route('teller.index')); ?>">Buka kasir</a></div>
        ...
        <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr><td><div class="transaction-name"><span class="tiny-icon <?php echo e($trx->direction === 'in' ? 'green' : 'red'); ?>"><?php echo e($trx->direction === 'in' ? '↓' : '↑'); ?></span><div><strong><?php echo e($trx->category); ?></strong><small><?php echo e($trx->trx_no); ?></small></div></div></td><td><?php echo e($trx->member?->name ?? 'Umum'); ?></td><td><?php echo e($trx->trx_date->format('d M, H:i')); ?></td><td class="right amount <?php echo e($trx->direction === 'in' ? 'in' : 'out'); ?>"><?php echo e($trx->direction === 'in' ? '+' : '-'); ?> Rp <?php echo e(number_format($trx->amount,0,',','.')); ?></td></tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody></table></div>
    </section>
    <section class="card">
        <div class="card-head"><div><h2>Kualitas Pinjaman</h2><p>Portofolio pinjaman berjalan</p></div><a href="<?php echo e(route('loans.index')); ?>">Detail</a></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Herd\koperasi-finance\resources\views/dashboard/index.blade.php ENDPATH**/ ?>